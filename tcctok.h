...
/* keywords */
     ...
     DEF(TOK_EXPLICIT, "explicit")
     DEF(TOK_MUTABLE, "mutable")
     DEF(TOK_CONST_CAST, "const_cast")
     DEF(TOK_STATIC_CAST, "static_cast")
     DEF(TOK_DYNAMIC_CAST, "dynamic_cast")
     DEF(TOK_REINTERPRET_CAST, "reinterpret_cast")
     DEF(TOK_TYPEID, "typeid")
     DEF(TOK_CATCH, "catch")
     DEF(TOK_THROW, "throw")
     DEF(TOK_TRY, "try")
     DEF(TOK_BOOL_CPP, "bool")
     DEF(TOK_TRUE, "true")
     DEF(TOK_FALSE, "false")
     DEF(TOK_NULLPTR, "nullptr")
     DEF(TOK_DECLTYPE, "decltype")
     DEF(TOK_NOEXCEPT, "noexcept")
